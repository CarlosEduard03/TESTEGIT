...
namespace medicina{
    ...
    let tabelaEnfermeiro = document.getElementById("tabelaEnfermeiro");
    let conteudo1 = "";
    ...
    let tabelaMedico = document.getElementById("tabelaMedico");
    let conteudo2 = "";
    ...
    let tabelaPaciente = document.getElementById("tabelaPaciente");
    let conteudo3 = "";
